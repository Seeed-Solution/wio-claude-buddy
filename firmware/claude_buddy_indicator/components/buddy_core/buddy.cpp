...
// ──────────────── shared geometry ────────────────
// Landscape port: the buddy lives in the left ~150 px pane (the right pane is
// the data view). Originals (portrait, 135-wide) were X_CENTER=67, Y_BASE=30,
// Y_OVERLAY=6.
const int BUDDY_X_CENTER = 75;     // center of the 0..150 left pane
const int BUDDY_CANVAS_W = 150;
const int BUDDY_Y_BASE   = 40;     // a little below the header
const int BUDDY_Y_OVERLAY = 16;
